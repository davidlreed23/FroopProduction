...
class FroopDataListener: NSObject, ObservableObject {
    ...
    func listenToInvitesList(uid: String, update: @escaping ([Froop]) -> Void) -> ListenerRegistration? {
    ...
    func listenToConfirmedList(uid: String, update: @escaping ([Froop]) -> Void) -> ListenerRegistration? {
        let uid = FirebaseServices.shared.uid
    ...
    func listenToDeclinedList(uid: String, update: @escaping ([Froop]) -> Void) -> ListenerRegistration? {
        let uid = FirebaseServices.shared.uid
