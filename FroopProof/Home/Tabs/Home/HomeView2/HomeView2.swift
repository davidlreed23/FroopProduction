...
//    @State private var previousConfirmedListCount: Int = 0
...
//                                    .foregroundColor(appStateManager.appState == .active ? Color(red: 249/255, green: 0/255, blue: 98/255 ) : colorScheme == .dark ? .white : .black)
//                                    .opacity(1)
//                                Button {
...
//                                                .fontWeight(appStateManager.selectedTab == 1 ? .semibold : .medium)
//                                                .foregroundColor(appStateManager.selectedTab == 1 ? Color(red: 249/255, green: 0/255, blue: 98/255) : .primary)
//                                                .onChange(of: invitationList.myConfirmedList.count, initial: (previousConfirmedListCount != 0)) { oldValue, newValue in
//                                                    if invitationList.myInvitesList.count == 1 {
//                                                        appStateManager.selectedTab = 1
//                                                    }
//
//                                                    // Update the previous count after processing the changes
//                                                    previousConfirmedListCount = newValue
//                                                }
//
//                                        }
//                                        .animation(.linear(duration: 0.2), value: appStateManager.selectedTab)
